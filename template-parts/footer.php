	...
	<div class="eccent_container eccent_footer_container">
		...
		<div class="eccent_footer_column">
			...
			<ul id="eccent_footer_ul_2" class="eccent_footer_ul">
				<li id="menu-item-709" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-709"><a href="<?php echo 'tel:' . get_theme_mod('eccent_contact_phone', '1-855-406-0424');?>"><img class="eccent_footer_contact_icon" src="https://wheelwish.com/wp-content/uploads/2020/11/telephone.svg"><?php echo get_theme_mod('eccent_contact_phone', '1-855-406-0424');?></a></li>
				<li id="menu-item-710" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-710"><a href="<?php echo 'mailto:' . get_theme_mod('eccent_contact_email', 'info@wheelwish.com');?>"><img class="eccent_footer_contact_icon" src="https://wheelwish.com/wp-content/uploads/2020/11/email.svg"><?php echo get_theme_mod('eccent_contact_email', 'info@wheelwish.com');?></a></li>
				<li id="menu-item-711" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-711"><a href="<?php echo get_theme_mod('eccent_contact_address_url', 'https://goo.gl/maps/2Xzinms41EnaszLp9');?>" class="customize-unpreviewable" target="_blank"><img class="eccent_footer_contact_icon" src="https://wheelwish.com/wp-content/uploads/2020/11/pin.svg"><span class="eccent_footer_contact_span"><?php echo get_theme_mod('eccent_contact_address', '846 Broken Sound Parkway NW, Boca Raton, Florida, 33487 USA');?></span></a></li>
			</ul>
		</div>
		<div class="eccent_footer_column">
